...
#             print("    Thumbnail:")
# 
#             if thumbnail.GetDataFormat() == KFbxThumbnail.eRGB_24 :
#                 print("        Format: RGB")
#             elif thumbnail.GetDataFormat() == KFbxThumbnail.eRGBA_32:
#                 print("        Format: RGBA")
# 
#             if thumbnail.GetSize() == KFbxThumbnail.eNOT_SET:
#                 print("        Size: no dimensions specified (%ld bytes)", thumbnail.GetSizeInBytes())
#             elif thumbnail.GetSize() == KFbxThumbnail.e64x64:
#                 print("        Size: 64 x 64 pixels (%ld bytes)", thumbnail.GetSizeInBytes())
#             elif thumbnail.GetSize() == KFbxThumbnail.e128x128:
...
#     
#     # Rotation Space
#     lRotationOrder = pNode.GetRotationOrder(KFbxNode.eSOURCE_SET)
# 
#     print("        Rotation Space:",)
# 
#     if lRotationOrder == eEULER_XYZ:
#         print("Euler XYZ")
#     elif lRotationOrder == eEULER_XZY:
#         print("Euler XZY")
#     elif lRotationOrder == eEULER_YZX:
#         print("Euler YZX")
#     elif lRotationOrder == eEULER_YXZ:
#         print("Euler YXZ")
#     elif lRotationOrder == eEULER_ZXY:
#         print("Euler ZXY")
#     elif lRotationOrder == eEULER_ZYX:
#         print("Euler ZYX")
#     elif lRotationOrder == eSPHERIC_XYZ:
#         print("Spheric XYZ")
#     
#     # Use the Rotation space only for the limits
#     # (keep using eEULER_XYZ for the rest)
#     if pNode.GetUseRotationSpaceForLimitOnly(KFbxNode.eSOURCE_SET):
...
#         print("RrSs")
#     elif lInheritType == eINHERIT_RSrs:
#         print("RSrs")
#     elif lInheritType == eINHERIT_Rrs:
#         print("Rrs")
# 
# 
