...
def DisplayGlobalLightSettings(pGlobalSettings):
    DisplayColor("Ambient Color: ", pGlobalSettings.GetAmbientColor())
    DisplayString("")


def DisplayGlobalCameraSettings(pGlobalSettings):
    DisplayString("Default Camera: ", pGlobalSettings.GetDefaultCamera().Buffer())
    DisplayString("")
