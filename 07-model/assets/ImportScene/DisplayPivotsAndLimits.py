...
from fbx import KFbxNode

def DisplayPivotsAndLimits(pNode):
    # Pivots
    print("    Pivot Information")

    lPivotState = pNode.GetPivotState(KFbxNode.eSOURCE_SET)
    if lPivotState == KFbxNode.ePIVOT_STATE_ACTIVE:
    ...
    # Limits
    lLimits = pNode.GetLimits()

    print("    Limits Information")

    lIsActive = lLimits.GetTranslationLimitActive()
    lMinXActive, lMinYActive, lMinZActive = lLimits.mTranslationLimits.GetLimitMinActive()
    lMaxXActive, lMaxYActive, lMaxZActive = lLimits.mTranslationLimits.GetLimitMaxActive()
    ...
    print("                Min Limit Value: %f" % lMinValues[0])
    if lMaxXActive:
        print("                Max Limit: Active")
    else:
        print("                Max Limit: Inactive")
    print("                Max Limit Value: %f" % lMaxValues[0])
    ...
    if lMinYActive:
        ...
        print("                Min Limit: Inactive")
    print("                Min Limit Value: %f" % lMinValues[1])
    if lMaxYActive:
        print("                Max Limit: Active")
    else:
        print("                Max Limit: Inactive")
    print("                Max Limit Value: %f" % lMaxValues[1])
    ...
    if lMinZActive:
        ...
        print("                Min Limit: Inactive")
    print("                Min Limit Value: %f"% lMinValues[2])
    if lMaxZActive:
        print("                Max Limit: Active")
    else:
        print("                Max Limit: Inactive")
    print("                Max Limit Value: %f" % lMaxValues[2])

    lIsActive = lLimits.GetRotationLimitActive()
    lMinXActive, lMinYActive, lMinZActive = lLimits.mRotationLimits.GetLimitMinActive()
    lMaxXActive, lMaxYActive, lMaxZActive = lLimits.mRotationLimits.GetLimitMaxActive()
    ...
    lMinXActive, lMinYActive, lMinZActive = lLimits.mScalingLimits.GetLimitMinActive()
    lMaxXActive, lMaxYActive, lMaxZActive = lLimits.mScalingLimits.GetLimitMaxActive()
